...
public class Judge {
    ...
    private String judge_people;
    private String judged_people;
    ...
    public Judge(int working_ability, int working_attitude, int environmental_behavior, int discipline, int bonus_point, int deduct_point, String judge_people, String judged_people) {
        ...
        this.judge_people = judge_people;
        this.judged_people = judged_people;

    }

    public Judge(Integer id, int working_ability, int working_attitude, int environmental_behavior, int discipline, int bonus_point, int deduct_point, Date judge_time, String judge_people, String judged_people) {
        this.id = id;
        this.working_ability = working_ability;
        this.working_attitude = working_attitude;
        this.environmental_behavior = environmental_behavior;
